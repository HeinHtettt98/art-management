import { diffcultPart, productCointainer, productTemplateC } from "../core/selector"
...
const productUi = ({ id, title, description, image, price, rating: { rate, count } }) => {
    ...
    productTemplate.querySelector(".product-parent").classList.add(id);
